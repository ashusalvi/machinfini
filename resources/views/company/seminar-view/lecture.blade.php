...
@section('content')
    ...
    @include('company.template-part.content-navigation', ['content' => $lecture])

    <div class="lecture-container-wrap d-flex">

        @include('company.template-part.curriculum_item_sidebar', ['content' => $lecture])
        ...
        <div class="lecture-container">
            ...
            @else
                ...
                <div class="lecture-contents-locked text-center mt-5">
                    ...
                    <a href="{{route('seminar_view', $course->slug)}}" class="btn btn-theme-primary btn-lg">Enroll in Course to Unlock</a>
