<div class="section-item-form-html  p-4 border">
    ...
    <form class="curriculum-edit-lecture-form" action="{{route('CS_update_lecture', [$item->seminar_id, $item->id])}}" method="post">
        @csrf
        ...
        <div id="lecture-video" class="section-item-tab-wrap" style="display: none;">
            ...
            <div class="lecture-video-upload-wrap">
                ...
                <p class="video-file-type-desc">
                    <small class="text-muted">Select your preferred video type. (.mp4) </small>
                </p>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="video-upload-wrap text-center">
                                    ...
                                    {!! media_upload_form('video[html5_video_id]', 'upload video', null, $item->video_info('html5_video_id')) !!}
                                </div>
                            </div>
