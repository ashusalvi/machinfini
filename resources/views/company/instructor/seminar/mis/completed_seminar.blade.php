            ...
            <table id="earning_table" class="table table-striped table-bordered display">
                ...
                <tbody>
                    @foreach ($completed_seminars as $completed_seminar)
                        ...
                        @endphp
                        <tr>
                            <td><a href="{{route('seminar_view', $completed_seminar->seminar->slug)}}" target="_blank">{{ $completed_seminar->seminar->title }}</a></td>
                            ...
                            @if (strtotime($due_date) >= strtotime($completed_date))
                            ...
                            <td>
                            {{ strtotime($due_date) < strtotime($completed_date)?$due_date->diffInDays($completed_date) : 0 }}</td>
                        </tr>
                    @endforeach
                </tbody>
            </table>
...
<script>
    $(function() {
        $('input[name="daterange"]').daterangepicker({
            ...
            let url = '/company/instroctor/all_instructor_completed_seminar/'+start_date+'/'+end_date;
