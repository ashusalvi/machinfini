<div class="section-item-form-html  p-4 border">
    ...
    <form class="curriculum-edit-quiz-form" action="{{route('CS_update_quiz', [$item->seminar_id, $item->id])}}" method="post">
        @csrf
        ...
        <div id="quiz-basic" class="section-item-tab-wrap" style="display: block;">
            ...
            <!-- Quiz Save Button -->
            <p style="color:red;">Please update “Passing Score” and “No of questions” under the Settings tab</p>
            <div class="form-group">
        ...
        <div id="quiz-questions" class="section-item-tab-wrap mb-5" style="display: none;">
            ...
            <div id="quiz-questions-wrap" class="mb-4">
                @include('company.instructor.seminar.quiz.questions', ['quiz' => $item])
            </div>
            ...
            <div id="quiz-settings-wrap">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                        ...
                        <p class="text-muted">
                            <small>If this quiz test affect on the students grading system for this seminar.</small>
                        </p>
                    </div>
                </div>
                ...
                <div class="form-row">
                    ...
                    <div class="form-group  col-md-4">
                        ...
                        <input type="number" class="form-control" name="quiz_option[passing_score]" value="{{$item->option('passing_score')}}" required>
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <input type="number" class="form-control" name="quiz_option[questions_limit]" value="{{$item->option('questions_limit', '')}}" required >
            ...
            <div class="question-basic-info  mb-1 d-flex justify-content-between">
                <div class="question-title">
                    <div class="form-group">
                        ...
                        <input type="text" name="question_title" class="form-control" placeholder="write question title">
                    </div>
                </div>
...
<div class="modal fade" id="quizQuestionTypeMoal" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <form action="{{route('CS_create_question', [$item->seminar_id, $item->id])}}" method="post" id="create-question-form">
                @csrf
