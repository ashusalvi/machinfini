            ...
            <table id="earning_table" class="table table-striped table-bordered display">
                ...
                <tbody>
                    @foreach ($employees as $employee)
                        ...
                        <td>
                            <a href="{{ route('CPA_employee_edit',[$employee->id]) }}"><i class="fa fa-edit"></i></a>
                            <a href="{{ route('CPA_employee_delete',[$employee->id]) }}"><i class="fa fa-trash" aria-hidden="true" style="color:red;"></i></a>
                        </td>
                        </tr>
                    @endforeach
                </tbody>
