...
<div class="company-header">
    <h5> Edit Company Employee </h5>
    {{-- <h5>  Hi  </h5> --}}
</div>

<div class="form-body">
    <form method="post" action="{{ route('CPA_employee_update',[$instructors->id]) }}" style="max-width: 1039px;">

        <h5 class="title"> Company Employee</h5>
        ...
        <div class="form-row">
            <div class="form-group col-md-4 {{form_error($errors, 'employee_id')->class}}">
                ...
                <input type="text" class="form-control" name="employee_id" placeholder="Enter employee id"
                    value="{{ $instructors->employee_id }}" required>
            ...
            <div class="form-group col-md-4 {{form_error($errors, 'name')->class}}">
                ...
                <input type="text" class="form-control" name="name" placeholder="Enter employee name"
                    value="{{ $instructors->user->name }}" required>
            ...
            <div class="form-group col-md-4 {{form_error($errors, 'department')->class}}">
                ...
                <select name="department" class="form-control" value="{{ old('department') }}">
                    ...
                    <option value="{{ $department->id }}" {{ $instructors->department_id ==  $department->id ? 'selected' : '' }}>
            ...
            <div class="form-group col-md-6 {{form_error($errors, 'email')->class}}">
                ...
                <input type="text" class="form-control" name="email" placeholder="Enter employee email"
                    value="{{ $instructors->user->email }}" required>
            ...
            <div class="form-group col-md-6 {{form_error($errors, 'phone')->class}}">
                ...
                <input type="number" class="form-control" name="phone" placeholder="Enter employee phone"
                    value="{{ $instructors->user->phone }}">
