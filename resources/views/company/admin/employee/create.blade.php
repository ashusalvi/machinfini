...
@section('content')
    ...
    <div class="form-body">
        <form method="post" action="{{ route('CPA_employee_upload') }}" style="max-width: 1039px;" enctype="multipart/form-data">

            <h5 class="title">Upload Company Employee</h5>
    ...
    <div class="form-body">
        <form method="post" action="{{ route('CPA_employee_store') }}" style="max-width: 1039px;">
