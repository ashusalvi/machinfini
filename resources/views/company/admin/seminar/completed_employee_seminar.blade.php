            ...
            <table id="earning_table" class="table table-striped table-bordered display">
                ...
                <tbody>
                    @foreach ($completed_seminars as $completed_seminar)
                        <tr>
                            <td>{{ $completed_seminar->companyEmployee($completed_seminar->user->id)->employee_id }}</td>
                            <td>{{ $completed_seminar->user->name }}</td>
                            {{-- <td>{{ $completed_seminar->user->phone }}</td> --}}
                            <td>{{ $completed_seminar->companyEmployeeDepartment($completed_seminar->user->id)->name }}</td>
                            {{-- <td>{{ $completed_seminar->completed_at }}</td> --}}
                            <td>{{ date($completed_seminar->completed_at) }}</td>
