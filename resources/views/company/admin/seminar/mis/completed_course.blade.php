                        ...
                        @foreach ($completed_courses as $completed_course)
                            ...
                            <tr>
                                ...
                                <?php 
                                    if(getScore($completed_course->course->id,$completed_course->companyEmployee($completed_course->user_id)->user_id) != '-1'){
                                ?>
                                <td>{{ round((getScore($completed_course->course->id,$completed_course->companyEmployee($completed_course->user_id)->user_id) / TotalScore($completed_course->course->id,$completed_course->companyEmployee($completed_course->user_id)->user_id) ) * 100,2) }}% </td>
                                ...
                                <td>
                                    <?php
                                        $percentage_value = ( getScore($completed_course->course->id,$completed_course->companyEmployee($completed_course->user_id)->user_id) / TotalScore($completed_course->course->id,$completed_course->companyEmployee($completed_course->user_id)->user_id) ) * 100;
...
<script>
    $(function() {
        $('input[name="daterange"]').daterangepicker({
            ...
            let url = '/company/admin/seminar/all_completed_course/'+start_date+'/'+end_date;
