            ...
            <table id="earning_table" class="table table-striped table-bordered display">
                ...
                <tbody>
                    @foreach ($response_array as$key =>  $response)
                        ...
                        @endphp
                        <tr>
                            <td><a href="{{route('seminar_view', $seminar->slug)}}" target="_blank">{{ $seminar->title }}</a></td>
                            ...
                            <td>
                                @php
                                    $completed_percent = $seminar->completed_percent(); 
                                @endphp
...
<script>
    $(function() {
        $('input[name="daterange"]').daterangepicker({
            ...
            let url = '/company/employee/all_employee_pending_seminar/'+start_date+'/'+end_date;
