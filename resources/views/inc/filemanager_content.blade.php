        ...
        <div class="modal-body">
            <div class="row">
                <div class="col-sm-4">
                    ...
                    @if (Auth::user()->user_type == 'admin' || Auth::user()->user_type =='instructor' || Auth::user()->user_type == 'company-instructor')
                    ...
                    <form id="adminMediaManagerModalForm" method="post"> @csrf
                        ...
                        <div class="form-group row">
                            <label for="mediaFileTitle"
                                class="col-sm-4 col-form-label col-form-label-sm text-right">Title</label>
                            <div class="col-sm-8">
                        ...
                        <div class="form-group row">
                            <label for="mediaFileAltText"
                                class="col-sm-4 col-form-label col-form-label-sm text-right">Alt Text</label>
                            <div class="col-sm-8">
