...
@section('content')
    ...
    @endif
    <form action="{{ route('cp_saveCoupon') }}" method="post">
        @csrf
        ...
        <div class="profile-basic-info bg-white p-3">
            ...
            <div class="form-row">
                ...
                <div class="form-group col-md-6 {{ form_error($errors, 'code')->class }}">
                    <label>{{ __t('Coupon Code') }}</label>
                        <span style="display: flex;">
                            <input value="MI{{Auth::user()->id}}-" style="width: 20%;" readonly="" disabled="">
                ...
                <div class="form-group col-md-6 {{ form_error($errors, 'percentage')->class }}">
                    ...
                    <input type="text" class="form-control" name="percentage" placeholder="Enter Coupon percentage ( % )"
                        value="{{ old('percentage') }}" min="1" max="50" id="percentage_value" onkeypress="return isNumber(event)" required>
            ...
            <div class="form-row">
                ...
                <div class="form-group col-md-6 {{ form_error($errors, 'from_date')->class }}">
                    ...
                    <input id="from_date_input" type="date" class="form-control" name="from_date" placeholder="Enter From Date"
            ...
            <table class="table table-striped table-bordered">
                ...
                @foreach ($coupons as $coupon)
                    <tr>
                            ...
                            @endif
                            <td><a href="{{route('cp_delete',[$coupon->id])}}"><button type="button" class="btn btn-danger">Delete</button></a></td>
                        </tr>
                @endforeach
