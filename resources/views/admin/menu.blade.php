<div class="navbar-default sidebar" role="navigation">
    ...
    <div class="sidebar-nav navbar-collapse">
        <ul class="nav" id="side-menu">
            ...
            <li>
                <a href="#"><i class="la la-newspaper-o fa-fw"></i> @lang('admin.cms')<span
            ...
            <li>
                <a href="#"><i class="la la-building fa-fw"></i> College / Company <span
                        class="la arrow"></span></a>
                <ul class="nav nav-second-level" style="display: none;">
                    <li>
                    ...
                    <li>
                        <a href="{{ route('companyCouponCreate') }}">@lang('admin.create') @lang('College')
                            @lang('Coupon')</a>
                    </li>
                    {{-- <li> 
            ...
            <li>
                <a href="#"><i class="la la-building fa-fw"></i> Curriculum <span class="la arrow"></span></a>
                <ul class="nav nav-second-level" style="display: none;">
                    <li>
                        <a href="{{ route('curriculum.create') }}"> Curriculum Create</a>
                    </li>
                    <li>
                        <a href="{{ route('curriculum.list') }}"> Curriculum List</a>
                    </li>
                    <li>
                        <a href="{{ route('curriculum.report') }}"> Curriculum
                            Inquiry</a>
                    </li>
                </ul>
            </li>
            ...
            <li> <a href="{{ route('admin_courses') }}"><i class="la la-chalkboard"></i> {{ __a('courses') }}</a>
            </li>
            ...
            <li> <a href="{{ route('payments') }}"><i class="la la-file-invoice-dollar"></i>
                    {{ __a('payments') }}</a>
            </li>
            <li> <a href="{{ route('earnings') }}"><i class="la la-file-invoice-dollar"></i>
                    {{ __a('earning') }}</a>
            </li>
            <li> <a href="{{ route('withdraws') }}"><i class="la la-wallet"></i> {{ __a('withdraws') }}</a>
            </li>
            ...
            <li> <a href="{{ route('create_collage_admin') }}"><i class="la la-user"></i> @lang('college_admin')</a>
            </li>
