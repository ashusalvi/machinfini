    ...
    <div>
        ...
        <form method="get" style="max-width: 1039px;">
            <table id="earning_table" class="table table-striped table-bordered display">
                ...
                <tbody>
                    @if (!empty($companies))
                        @foreach ($companies->coupon($companies->id) as $coupon)
                            <tr>
...
<script>
    $(function() {
        $('input[name="daterange"]').daterangepicker({
            ...
            let url = '/admin/company/mis/mis_course_status/'+start_date+'/'+end_date;
            if (company != "") {
                url += '/'+company;
            }
    ...
    $("#company").change(function(){
        ...
        let url = '/admin/company/mis/mis_course_status/'+from_date+'/'+to_date+'/'+company;
        window.location.href =url ;
    });
</script>
