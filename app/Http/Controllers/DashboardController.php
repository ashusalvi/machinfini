...
class DashboardController extends Controller
{
    public function index(){
        ...
        if($user->user_type == 'channel_partner'){
            $channel_partner_erning = channelPartnerEarning::where('user_id',$user->id)->get();
        }

        return view(theme('dashboard.dashboard'), compact('title', 'chartData','channel_partner_erning'));
    }
