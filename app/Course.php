...
class Course extends Model
{
    ...
    public function sections(){
        return $this->hasMany(Section::class)->orderBy('id', 'asc');
    }
    ...
    public function completedCourse($course_id,$user_id){
        return Complete::where('completed_course_id',$course_id)->where('user_id',$user_id)->count();
    }
    ...
    public function getEnrollCourse($course_id,$user_id)
    {
        $enroll = Enroll::where('course_id',$course_id)->where('user_id',$user_id)->count();
        if($enroll >= 1)
        {
            return true;
        }
