...
class CreateCompanySeminarContentsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('company_seminar_contents', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('company_seminar_contents');
    }
}